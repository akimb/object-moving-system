...
@onready var cursor: TextureRect = $"../Player UI/Cursor"

var current_object : Object
var last_object : Object
var interaction_component : Node # this is dynamic to other objects

const RESTING_CURSOR : CompressedTexture2D = preload("res://Player/resting_cursor.png")
const GRABBING_CURSOR : CompressedTexture2D = preload("res://Player/grabbing_cursor.png")
const HOVER_CURSOR : CompressedTexture2D = preload("res://Player/hover_cursor.png")
...
func object_interaction_helper() -> void:
	if current_object:
		...
		if potential_object is MovableObject:
			...
			player.current_object = last_object
